...
@Data
@Node("ClosedDetectionState")
public class ClosedDetectionState implements DetectionState {
	/* neo4j id */
	@Id @GeneratedValue 
	private UUID id;
	...
	public void calculateDetectionState() {
		detection.setCurrentDetectionState(detection.getClosedDetectionState());
	}
}