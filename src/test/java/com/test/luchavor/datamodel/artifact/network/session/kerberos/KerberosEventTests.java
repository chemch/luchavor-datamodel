package com.test.luchavor.datamodel.artifact.network.session.kerberos;
...
public class KerberosEventTests {
	public List<KerberosEvent> getKerberosEventList1() {
		...
		event.setTimestamp(DataTypeConverter.convertDoubleEpochTimestamp(1689646377.46308));
		...
		event.setFrom(null);
		event.setTill(DataTypeConverter.convertLongEpochTimestamp((long) 2136422885));
