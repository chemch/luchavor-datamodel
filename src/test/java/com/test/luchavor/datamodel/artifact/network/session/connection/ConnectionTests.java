package com.test.luchavor.datamodel.artifact.network.session.connection;
...
public class ConnectionTests {
	public Connection getTestConnection1() {
		...
		// populate connection
		connection.setTimestamp(DataTypeConverter.convertDoubleEpochTimestamp(1689560080.32542));
	...
	public Connection getTestConnection2() {
		...
		Connection connection = new ConnectionImpl();
		// populate connection
		connection.setTimestamp(DataTypeConverter.convertDoubleEpochTimestamp(1689644622.66883));
	...
	public Connection getTestConnection3() {
		...
		Connection connection = new ConnectionImpl();
		// populate connection
		connection.setTimestamp(DataTypeConverter.convertDoubleEpochTimestamp(1689646377.46308));
	...
	public Connection getTestConnection4() {
		...
		Connection connection = new ConnectionImpl();
		// populate connection
		connection.setTimestamp(DataTypeConverter.convertDoubleEpochTimestamp(1689721214.20921));
	...
	public Connection getTestConnection5() {
		...
		Connection connection = new ConnectionImpl();
		// populate connection
		connection.setTimestamp(DataTypeConverter.convertDoubleEpochTimestamp(1689721214.20644));
	...
	public Connection getTestConnection7() {
		...
		Connection connection = new ConnectionImpl();
		// populate connection
		connection.setTimestamp(DataTypeConverter.convertDoubleEpochTimestamp(1689819179.07213));
