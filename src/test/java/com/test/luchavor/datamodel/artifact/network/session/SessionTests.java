package com.test.luchavor.datamodel.artifact.network.session;
...
import com.test.luchavor.datamodel.artifact.network.session.dns.DnsEventTests;
import com.test.luchavor.datamodel.artifact.network.session.http.HttpEventTests;
import com.test.luchavor.datamodel.artifact.network.session.kerberos.KerberosEventTests;
import com.test.luchavor.datamodel.artifact.network.session.ntlm.NtlmEventTests;
import com.test.luchavor.datamodel.artifact.network.session.rpc.RpcEventTests;
import com.test.luchavor.datamodel.artifact.network.session.smb.SmbEventTests;
import com.test.luchavor.datamodel.artifact.network.session.ssl.SslEventTests;
